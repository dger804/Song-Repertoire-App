...
`categories` y `songs` ya exponen CRUD con DTOs y validacion global. Las demas colecciones preparan persistencia, pero todavia no exponen endpoints CRUD ni reglas de autorizacion ejecutables.
